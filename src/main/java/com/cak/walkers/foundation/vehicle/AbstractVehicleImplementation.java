...
public class AbstractVehicleImplementation {
    ...
    public void tick() {
        ...
        movementDelta = legStepManager.constrainMovement(movementDelta);
        ...
        while (!balanced) {
            ...
            if (!balanced) {
                ...
                double gradientDelta = (imbalanceDirection.getStep() * -0.5f) / balancePair.first().offset();
